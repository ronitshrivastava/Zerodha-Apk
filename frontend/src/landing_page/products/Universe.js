...
function Universe() {
    return (  
        ...
        <div className="col-4 p-3 mt-5">
          <img src="media/images/streakLogo.png" style={{width:"20vh"}}/>
          <p className="text-small text-muted mt-2">Algo & strategy platform</p>
        </div>
        <div className="col-4 p-3 mt-5">
          <img src="media/images/sensibullLogo.svg " style={{width:"30vh"}}/>
        ...
        <div className="col-4 p-3 mt-5">
          <img src="media/images/goldenpiLogo.png" style={{width:"27vh"}}/>
          <p className="text-small text-muted mt-2">Bonds trading platform</p>
        </div>
        <div className="col-4 p-3 mt-5">
          <img src="media/images/dittoLogo.png" style={{width:"38%"}}/>
          <p className="text-small text-muted mt-2">Insurance</p>
        </div>
         <button className='p-2 btn btn-primary fs-5mb-5' style={{width:"20%", margin:"0 auto" }}>
                    Signup Now
                </button>
            </div>
        </div>
